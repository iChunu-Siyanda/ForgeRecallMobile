...
import 'package:forge_recall/feautures/profile/presentation/widgets/profile_stat_card.dart';
      ...
      child: Column(
        children: [
          ...
          Row(
            children: const [
              Expanded(
                child: ProfileStatCard(title: 'Streak', value: '17'),
              ),
              SizedBox(width: 14),
              Expanded(
                child: ProfileStatCard(title: 'Sessions', value: '241'),
              ),
              SizedBox(width: 14),
              Expanded(
                child: ProfileStatCard(title: 'Hours', value: '84h'),
              ),
            ],
          ),
        ],
