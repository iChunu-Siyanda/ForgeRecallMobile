...
import 'package:forge_recall/feautures/analytics/presentation/widgets/performance_metric.dart';
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: const [
              Expanded(
                child: PerformanceMetric(title: 'Avg Speed', value: '2.8s'),
              ),
              SizedBox(width: 14),
              Expanded(
                child: PerformanceMetric(title: 'Sessions', value: '241'),
              ),
              SizedBox(width: 14),
              Expanded(
                child: PerformanceMetric(title: 'Accuracy', value: '92%'),
              ),
            ],
          ),
        ],
