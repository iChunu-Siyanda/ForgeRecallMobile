  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const Row(
          children: [
            Expanded(child: MetricCard(value: "2.8s", label: "Response")),

            SizedBox(width: 14),

            Expanded(child: MetricCard(value: "91%", label: "Accuracy")),
          ],
        ),
        ...
        const Row(
          children: [
            Expanded(child: MetricCard(value: "17", label: "Streak")),

            SizedBox(width: 14),

            Expanded(child: MetricCard(value: "4h", label: "Focus")),
          ],
        ),
      ],
    );
